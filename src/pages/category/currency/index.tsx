...
import { createCurrency, searchCurrency, updateCurrency } from '@/api/currency';
      ...
      <MyPage
        ...
        searchRender={
          <>
            ...
            <SearchItem label="Biểu tượng" name="symbol" type="input" />
      ...
      >
        <Form form={form} layout="vertical" colon={false}>
          ...
          <div style={{ display: 'flex', gap: '16px' }}>
            ...
            <Form.Item name="symbol" label="Biểu tượng" style={{ flex: 1 }}>
              <Input />
            </Form.Item>
          </div>
          <div style={{ display: 'flex', gap: '16px' }}>
